...
ALTER TABLE PROLINGO_USER ADD ACCURE_DATE NUMBER DEFAULT 0;          -- 누적 학습 일수
ALTER TABLE PROLINGO_USER ADD LAST_LOGIN DATE default '00/01/01'; -- 최종 로그인 일자

ALTER TABLE PROLINGO_USER MODIFY ACCURE_DATE NUMBER DEFAULT 0;
ALTER TABLE PROLINGO_USER MODIFY LAST_LOGIN DATE default '00/01/01';

ALTER TABLE PROLINGO_USER DROP COLUMN ACCURE_DATE;
ALTER TABLE PROLINGO_USER DROP COLUMN LAST_LOGIN;
